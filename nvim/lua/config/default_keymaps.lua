...
-- Diagnostics moved to workspace group (<leader>w)
vim.keymap.set({ 'n', 'v' }, '<leader>we', vim.diagnostic.open_float, { desc = 'Show diagnostic [E]rror messages' })
vim.keymap.set({ 'n', 'v' }, '<leader>wq', vim.diagnostic.setloclist, { desc = 'Open diagnostic [Q]uickfix list' })
