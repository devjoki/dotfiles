...
return {
  {
    ...
    config = function()
      ...
      require('which-key').add {
        ...
        { '<leader>wl', group = '[L]SP' },
        { '<leader>wle', vim.diagnostic.open_float, mode = { 'n', 'v' }, desc = 'Show diagnostic [E]rror messages' },
        { '<leader>wlq', vim.diagnostic.setloclist, mode = { 'n', 'v' }, desc = 'Open diagnostic [Q]uickfix list' },
        { '<leader>g', group = '[G]it' },
